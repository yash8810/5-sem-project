...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">SNACKES</a>
    ...
    <main>
        <h2  class="m-0 text-primary">SNACKS</h2>
        <div class="container">
            <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                    <div class="product">
                        <form action="snackes.php?action=add&id=<?php echo $row["pid"] ?>" method="post">
                            <div class="product">
                                ...
                                <!-- <button name="submit"><i class="fas fa-shopping-cart fa-lg"  style="color: #fe5d37;"></i></button> -->
