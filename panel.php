...
<header role="banner">
   <img src="munchbag logo.jpg" width="80px">
  
  <ul class="utilities">
    <br>
    <li class="write"><a href="addproduct.php">Add product</a></li>
    <li class="write"><a href="view.php">view product</a></li>
    <li class="write"><a href="customerdetails.php">view customer detail</a></li>
        
    <li class="logout warn"><a href="login.php">Log Out</a></li>
  </ul>
</header>
...
<body>
    <center>
        <form enctype="multipart/form-data" method="post">
            ...
            <input type="text" placeholder="Enter product name" name="pname" width="50px"required><br><br>

            <label for="discription">DISCRIPTION:</label>
            <input type="text" placeholder="Enter product description" name="dis" required><br><br>
