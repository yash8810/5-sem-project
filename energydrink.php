...
if (mysqli_connect_errno()) {
    ...
    if (isset($_POST["submit"])) {
        ...
        // $insrt1 = "INSERT  into bill (total) values ('$total')";
        // mysqli_query($conn, $insrt1);
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">ENERGYDRINKS</a>
    ...
    <main>
        <h2  class="m-0 text-primary">ENERGY DRINKS</h2>
        <div class="container">
            <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                    <div class="product">
                        <form action="energydrink.php?action=add&id=<?php echo $row["pid"] ?>" method="post">
                            <div class="product">
